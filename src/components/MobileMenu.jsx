    ...
    return (
        ...
        `}>
            <button 
                ...
                className="absolute top-5 right-5 text-3xl text-white focus:outline-none cursor-pointer"
                aria-label="Close Menu">
                &times;
            </button>
            <a href="#home" className={`text-2xl font-semibold text-white mb-4 transform transition-transform duration-300
